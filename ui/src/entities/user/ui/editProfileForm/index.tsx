...
export const EditProfileForm = observer(
  ({ onSave, onCancel, children }: EditProfileFormProps) => {
    ...
    const hasChanges = user && formData.name !== user.name;
    ...
    return (
      <Card className="w-full max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Обновите информацию о своем профиле. Имя пользователя изменить
            нельзя.
          </CardDescription>
        </CardHeader>
