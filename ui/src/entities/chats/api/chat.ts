...
export const getAllChats = async (options: { sort?: string; filter?: string; expand?: string } = {}) => {
...
export const getFirstChat = async (filter: string, options: { expand?: string } = {}) => {
...
export const createChat = async (participantsIds: string[], title?: string): Promise<Chat> => {
    try {
