import { Sidebar, SidebarContent, SidebarGroup, SidebarGroupLabel, SidebarGroupContent, SidebarProvider, SidebarHeader } from '@/components/ui/sidebar'
            ...
            <Sidebar>
                ...
                <SidebarContent >
                    <SidebarGroup>
                        ...
                        <SidebarGroupContent >
                            <ChatList filterUsers={filterUsers} handleNewChat={handleNewChat} />
                        </SidebarGroupContent>
                    </SidebarGroup>
                </SidebarContent >
            </Sidebar>
